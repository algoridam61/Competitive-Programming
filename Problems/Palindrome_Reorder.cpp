...
void solve()
{
    ...
    if (n%2 == 0 && odd_count) {cout<<"NO SOLUTION";L;return;}
    if (n%2 == 1 && odd_count > 1) {cout<<"NO SOLUTION";L;return;}
    ...
    f(i, 26)
    {
        if (freqs[i] % 2 == 0) 
        {
            f(j, freqs[i] / 2)
            {
                final_string[ind] = 'A' + i;
                final_string[n - 1 - ind] = 'A' + i;
                ind++;
            }
        }
        else 
