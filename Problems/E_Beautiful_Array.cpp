...
void solve()
{
    ...
    if (a==b) 
    {
        cout<<1;L;cout<<a;L;return;
    }
    else 
    {
        // lets try to make arrays of size 4
        // so the sum of mid 2 elements is 2*b
        // we know that the sum of the 4 elements is 4*a
        // hence the remaining 2 elements should have sum 4*a-2*b
        // so make them 2*a - b each if this number is greater than zero
        cout<<3;L;
        cout<<-100000<<" "<<b<<" "<<3*a-b+100000;L;
    }
