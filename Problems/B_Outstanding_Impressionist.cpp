...
void solve()
{
    ...
    f(i,n)
    {
        if (l[i]==r[i]) {s.push_back(l[i]);mp[l[i]]++;}
    }   
    sortall(s);
    ...
    f(i,n)
    {
        ...
        {
            // find the element in the set less than l1 and greater than r1
            // find number of elements greater than equal to l1 and less than equal to r1

            // find indice of l1 and r1 in the vector s
            int ind1 = lower_bound(s.begin(),s.end(),l1)-s.begin();
            int ind2 = upper_bound(s.begin(),s.end(),r1)-s.begin();
            // cout<<ind1<<" "<<ind2;L;
            if (ind2-ind1==r1-l1+1) cout<<0;
            else cout<<1;
        }
    }
    L;
