...
################################################################################
*/ 
// returns the increase to the answer
pl rec(ll n,ll k)
{
    ...
    if (n%2==0)
    {
        return {2*curr.first+curr.second*(n/2),curr.second*2};
    }
    else 
    {
        return {2*curr.first+(curr.second+1)*(n/2+1),curr.second*2+1};
    }
    // return ans,count and exploit symmetry.
}
void solve()
{
    ll n;cin>>n;
