...
void solve() {
    ...
    // no way to store the numbers 
    // so use absolute formula of fibonacci numbers
    // but this is not that accurate

    // need some log n algorithm to find the nth fibonacci number
